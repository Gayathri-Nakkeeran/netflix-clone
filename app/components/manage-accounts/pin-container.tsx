...
type pinProps = {
  showPinContainer: { account: { _id: string }; show: boolean };
  pinError: boolean;
  pin: string;
  handlePinSubmit: (value: string, index: number) => Promise<void>;
  setShowPinContainer: ({
    account,
    show,
  }: {
  ...
  setPinError: (arg0: boolean) => void;
  setPin: (arg0: string) => void;
};
